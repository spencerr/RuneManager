        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <router-link to = "/" class="waves-effect waves-primary"><i class="ti-home"></i><span> Dashboard </span></router-link>
                    </li>

                    <li>
                        <router-link :to="{ name: 'login' }" class="waves-effect waves-primary"><i class="ti-home"></i><span> Login </span></router-link>
                    </li>
